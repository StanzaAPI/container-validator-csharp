...
namespace StanzaApi.ContainerValidator
{
    public class ContainerValidatorClient
    {
        private readonly HttpClient _httpClient;
        private readonly string _apiKey;
        private readonly string _baseUrl;
        public string ToolUrl { get; } = "https://stanzaapi.com/tools/container-validator";

        public ContainerValidatorClient(string apiKey = null, string baseUrl = null, HttpClient httpClient = null)
        {
